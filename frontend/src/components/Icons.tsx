...
//
// 🎨 გაზიარებული, მინიმალისტური stroke-based SVG icon-ები (feather-style) —
// ერთი წყარო emoji icon-ღილაკების ჩანაცვლებისთვის აპლიკაციის მასშტაბით
// (Tables.tsx, Modifiers.tsx, Ingredients.tsx და შემდგომ სხვაგანაც) — რომ
// OS-დამოუკიდებელი, ერთგვაროვანი ზომის/სისქის რენდერი იყოს და თემასთან
// (light/dark) ავტომატურად თანხმდებოდეს (`currentColor`, ღილაკის `color`-ს
// მისდევს).
...
// 📥 მარაგის შევსება ("restock") — შემომავალი ინვენტარის ვიზუალური ანალოგი.
export function RestockIcon({ size = 16 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={size} height={size} aria-hidden="true">
...
// 🔓/🔒 მომხმარებლის სტატუსის toggle-ისთვის (აქტიური/დაბლოკილი).
...
// 🚪 სისტემიდან გამოსვლა — "კარი + გამომავალი ისარი" (log-out).
...
// (Vercel-ის sidebar-ის მსგავსი, monochrome, active/hover-ზე ტექსტის
// ფერს ავტომატურად მისდევენ).
// ==========================================
...
export function ShoppingCartIcon({ size = 16 }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={size} height={size} aria-hidden="true">
...
// ⚙️ Settings გვერდისთვის (Roadmap "HoReCa Open Items - 06.09.2026.md", #3) —
// LayersIcon-ის იგივე feather-style, gear-ის კლასიკური SVG.
